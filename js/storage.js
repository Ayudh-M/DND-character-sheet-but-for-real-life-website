...
import { $, setCookie, getCookie, modFromScore } from './util.js';
import { statOrder } from './stats.js';
import { getPortrait, setPortrait } from './portrait.js';

const LS_KEY = 'dnd_irl_sheet_v3';
...
export function gatherState() {
  return {
    ...
    stats: Object.fromEntries(statOrder.map(key => {
      const score = parseInt($(`#${key}-num`).value, 10) || 10;
      return [key, { score, mod: modFromScore(score) }];
    })),
